    ...
    <div className="container">
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group controlId="appointmentTime">
          ...
          <Form.Control type="time" value={appointmentTime} onChange={(event) => setAppointmentTime(event.target.value)} />
        </Form.Group>
        <Form.Group controlId="doctorName">
          <Form.Label>Doctor Name</Form.Label>
          <Form.Control type="text" value={doctorName} onChange={(event) => setDoctorName(event.target.value)} />
        </Form.Group>
